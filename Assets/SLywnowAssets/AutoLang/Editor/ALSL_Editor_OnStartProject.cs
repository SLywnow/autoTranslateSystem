	...
	public class ALSL_Editor_OnStartProject
	{
		...
		public static void Run()
		{
			...
			else
			{
				...
				Debug.LogError("You delete alsl_perfab.prefab! Please restore it or reimport asset!");
			}
			...
			if (ALSL_Editor_System.enable)
			{
				...
				{
					Debug.Log("First lauch detected, creating basic data!");
					dw.alllangs.Add("EN_en");
					dw.langsvis.Add("Enligh");
					dw.assotiate.Add("English");
					FilesSet.SaveStream(ALSL_Editor_System.folderlink, "keys", "txt", new string[0], false);
					FilesSet.SaveStream(ALSL_Editor_System.folderlanglink, "EN_en", "json", "{ }");
					clearrun = true;
				}
